...
;
MON_NXTDRV      .EQU    PGZERO_ST+52            ;IDE CHS Variables for DOS/65
MON_NXTTRK      .EQU    PGZERO_ST+53
MON_NXTSEC      .EQU    PGZERO_ST+54
MON_CURDRV      .EQU    PGZERO_ST+55
;
...
;HSTBUF                                          ;Doubles as HSTBUF for DOS/65
...
; Calls 02-04 are currently Reserved
;
M_COLD_MON              .EQU    $E000           ;Call 00   Monitor Cold Start
M_WARM_MON              .EQU    $E003           ;Call 01   Monitor Warm Start
;
M_MOVE_RAM              .EQU    $E009           ;Call 03   Move Memory (variables previously set)
M_FILL_RAM              .EQU    $E00C           ;Call 04   Fill Memory (variables previously set)
...
;
B_IDE_RESET             .EQU    $FF00           ;Call 00   Reset IDE controller
B_IDE_GET_STAT          .EQU    $FF03           ;Call 01   Get extended status from IDE
B_IDE_IDENTIFY          .EQU    $FF06           ;Call 02   Execute/Load identity data
B_IDE_READ_LBA          .EQU    $FF09           ;Call 03   Read a LBA from IDE
B_IDE_WRITE_LBA         .EQU    $FF0C           ;Call 04   Write a LBA to IDE
B_IDE_VERFY_LBA         .EQU    $FF0F           ;Call 05   Verify LBA to IDE
B_IDE_SET_LBA           .EQU    $FF12           ;Call 06   Set the requested LBA
B_IDE_SET_ADDR          .EQU    $FF15           ;Call 07   Set the data transfer address
;
B_RTC_NVRD              .EQU    $FF18           ;Call 08   Read RTC NVRAM data (256 bytes)
B_RTC_NVWR              .EQU    $FF1B           ;Call 09   Write RTC NVRAM data (256 bytes)
B_RTC_INIT              .EQU    $FF1E           ;Call 10   Initialize software RTC from HW RTC
;
...
;
B_CNT_INIT              .EQU    $FF2D           ;Call 15   Initalize Benchmark Counter
B_CNT_STRT              .EQU    $FF30           ;Call 16   Start Benchmark Counter
B_CNT_STOP              .EQU    $FF33           ;Call 17   Stop Benchmark Counter
;
B_CHRIN_NW              .EQU    $FF36           ;Call 18   Console character in, no waiting
B_CHRIN                 .EQU    $FF39           ;Call 19   Console console in, waits for data
B_CHROUT                .EQU    $FF3C           ;Call 20   Console character out
;
B_SET_DLY               .EQU    $FF3F           ;Call 21   Sets timer driven delay (16-bit)
B_EXE_MSDLY             .EQU    $FF42           ;Call 22   Execute 10 millisecond delay count
B_EXE_LGDLY             .EQU    $FF45           ;Call 23   Execute 16-bit delay count
B_EXE_XLDLY             .EQU    $FF48           ;Call 24   Extended period delay (1-256 times above)
;
B_INIT_VEC              .EQU    $FF4B           ;Call 25   Initialize System Soft Vectors ($0300)
B_INIT_CFG              .EQU    $FF4E           ;Call 26   Initialize Soft Configuration Data ($0320)
B_INIT_2691             .EQU    $FF51           ;Call 27   Initalize the 2691 UART (console/timer)
B_RESET_2691            .EQU    $FF54           ;Call 28   Reset the 2691 UART
;
B_WRMMNVEC0             .EQU    $FF57           ;Call 29   Warm Monitor Vector entry
B_CLDMNVEC0             .EQU    $FF5A           ;Call 30   Cold Monitor Vector entry
B_COLDSTRT              .EQU    $FF5D           ;Call 31   Cold Start/Boot system (enters Monitor)
;
;**************************************************************************************************
;
        .END